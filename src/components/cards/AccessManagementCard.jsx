...
export default function AccessManagementCard({ card }) {
  return (
    <div className="max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 cursor-pointer transition duration-300 hover:scale-105 hover:shadow-lg">
      <div className="flex flex-col justify-center items-center gap-4 m-2 ">
        ...
        <div className="text-center ">
          <h5 className="font-dm text-2xl font-medium text-gray-600">
            {card.title}
          </h5>
          <p className="text-md pt-2">{card.description}</p>
        </div>
